...
console.log(fruits, "---simple array---");
// ========== Q # 2 ===========
let number = [10, 20, 30, 40];
console.log(number, "---array that can only contain numbers---");
// ========== Q # 3 ============
...
// ============ Q # 5 ===========
fruits.push("grapes");
console.log(fruits, "---adding element `grape`---");
// ========== Q # 6 =============
...
// =========== Q # 9 =============
fruits.splice(1, 2);
console.log(fruits, "---removig 2 elements from starting from index 1");
// ========= Q # 10 =========
